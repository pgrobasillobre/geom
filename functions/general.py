...
def read_command_line(argv,inp):
   ...
   if argv[1] == '-h' or argv[1] == '-help':
      ...
      print ('')
      print ('       -t distances_input geom1.xyz origin_CM_1{origin_CM_1_yes/no} geom2.xyz origin_CM_2{origin_CM_2_yes/no} axis{+-}{x/y/z} verbose{verbose_yes/no}')
      print ('')
      print ('     One translation:')
      print ('')
      print ('       -t1 shift geom.xyz origin_CM{origin_CM_yes/no} axis{+-}{x/y/z}')
      print ('')
      print ('')
      print ('     ---------')
      print ('     Rotation:')
      ...
      print ('')
      print ('       -r angles_input geom.xyz origin_CM{origin_CM_yes/no} axis{+-}{x/y/z}')
      print ('')
      print ('     One rotation:')
      print ('')
      print ('       -r1 angle geom.xyz origin_CM{origin_CM_yes/no} axis{+-}{x/y/z}')
      print ('')
      print ('')
      print ('     -----------------')
      ...
      print ('     Graphene:')
      print ('')
      print ('       Ribbon (X: zigzag | Y: armchair): -create -graphene rib X_length Y_length')
      print ('')
      print ('       Disk: -create -graphene disk radius')
      print ('')
      print ('       Ring: -create -graphene ring radius_out radius_in')
      print ('')
      print ('       Triangle: -create -graphene triangle edge_type{armchair/zigzag} side_length')
      print ('')
      print ('     Nanoparticles (Ag/Au/Na):')
      print ('')
      print ('       Sphere: -create -sphere atom_type radius center_x center_y center_z [optional: -alloy atom_type -percentual float]')
      print ('')
      print ('       Rod: -create -rod atom_type length width main_axis{X/Y/Z} [optional: -alloy atom_type -percentual float]')
      print ('')
      print ('       Tip (elliptic paraboloid): -create -tip atom_type z_max a b [optional: -alloy atom_type -percentual float]')
      print ('')
      print ('       Pyramid (square base): -create -pyramid atom_type z_max base_side_length [optional: -alloy atom_type -percentual float]')
      print ('')
      print ('       Cone: -create -cone atom_type z_max base_radius [optional: -alloy atom_type -percentual float]')
      print ('')
      print ('       Microscope: -create -microscope atom_type z_max_paraboloid a b z_max_pyramid base_side_length [optional: -alloy atom_type -percentual float]')
      print ('')
      print ('     ----------------')
      print ('     Merge Geometries')
      print ('     ----------------')
      print ('')
      print ('     -merge geom1.xyz geom2.xyz cutoff(Å)')
      print ('')
